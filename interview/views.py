...
def interview_page(request):
    ...
    if request.method == 'POST':           
        ...
        if(message == "start" or message == "Start"):
            response = generate_questions(f"can you be my interviewer, ask me {num_of_quetions}, python quetions, each quetion one by one and i will provide you answer, and at the end provide feedback of all answers.")
